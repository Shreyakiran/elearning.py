...
# ==========================================================
# 💅 SASSY & PROFESSIONAL UI (Custom CSS)
# ==========================================================
def apply_ui_design():
    st.markdown("""
        <style>
        ...
        .death-date { color: #FF4B4B; font-size: 28px; font-weight: bold; font-family: 'Courier New'; }
...
# 🔐 CONFIG & SESSION
# ==========================================================
GROQ_API_KEY = "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" 
